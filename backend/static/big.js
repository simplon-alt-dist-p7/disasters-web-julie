// Lightweight version of big.js to avoid artificial CPU/memory load
// Loads a minimal stylesheet and provides a gentle hue animation.

(function () {
  const link = document.createElement('link');
  link.rel = 'stylesheet';
  // Use relative URL so it works behind proxies or different hosts
  ...
  // Minimal heartbeat log for debugging in dev only
  if (typeof window !== 'undefined' && window.location.hostname === 'localhost') {
    console.debug('light big.js loaded')
  }
})();

// --------------------------------------------------------------------------
// Previous heavier version for reference (commented out to avoid accidental use)
